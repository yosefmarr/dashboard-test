...
const adminController = {
  async init() {
    try {
      ...
      document.title = i18n.t('admin', 'title');
      const generateTemplate = compileTemplate(adminTemplate());
      userData.actualPath = '/admin';
      ...
      const languageSwitcher = new LanguageSwitcher(i18n, 'admin');
